...
class Order(models.Model):
    ...
    shippingPrice = models.DecimalField(max_digits=4, decimal_places=2, null=False, blank=False)
    totalPrice = models.DecimalField(max_digits=4, decimal_places=2, null=False, blank=False)
    taxPrice = models.DecimalField(max_digits=4, decimal_places=2, null=False, blank=False)
